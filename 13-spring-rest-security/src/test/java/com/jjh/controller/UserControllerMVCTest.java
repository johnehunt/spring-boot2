...
public class UserControllerMVCTest {
    ...
    @Test
    public void validateNoUnauthorizedAccess401() throws Exception {
    ...
    @Test
    @WithMockUser("user") // //@WithMockUser(username = "USER")
    ...
    @Test
    public void testUnauthorizedNewUserRequest() throws Exception {
        String url = "/users";
